        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col mt-7">
            ...
            <textarea
              ...
              id=""
              className="w-9/12 border-gray-400 resize-none outline-none border-2 rounded-lg p-2"
            ></textarea>
          </div>
          <div className="flex flex-col">
            ...
            <textarea
              ...
              id=""
              className="w-9/12 outline-none resize-none border-gray-400 border-2 rounded-lg p-2"
            ></textarea>
          </div>

...
const Sliders = () => {
  ...
  return (
    <div className="mx-auto w-full h-auto bg-[#007F00] rounded-3xl   flex flex-col">
      <div className=" pt-16 pb-16 flex flex-row  ">
        <h1 className=" mx-auto mr-auto text-3xl font-semibold text-[#ffffff]">
          Why People Choose Goufer
        </h1>

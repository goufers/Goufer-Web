  ...
  return (
    <div className="w-fit h-fit mx-auto my-[-10px]">
      ...
      <div>
          ...
          <p className="items-normal text-[12px] font-thin">
            The Head of Hospitality Department at our Luxury resort is
            responsible for ensuring exceptional guest experience and overseeing
            all hospitality operations.This is leadership role demands a
            commitment to excellence, innovative thinking, a passion for

...
const PaymentAdd : React.FC = () =>{
    ...
    return (
      ...
      <div className="flex flex-col items-center  mx-auto w-[480px] h-[626px] hover:shadow-lg shadow-md bg-white rounded-[15px] mt-12 gap-2">
         ...
         <div className="flex flex-col items-center  w-[432px] h-[506px] mt-6 font-Roboto">
            ...
            <div className=" flex flex-col w-[316px] h-[190px] rounded-[20px] shadow-lg p-4 bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg border border-white">
                ...
                <img src="./images/gouferwhite.svg" alt="Goufer" className="w-[42px] h-[13px]" />
               ...
               <div className="flex flex-col text-white">
                ...
                <img src="./images/whitemastacard.svg" alt="master card"  className="w-[45px] h-[32px]"/>
               </div>
        ...
        <button className="w-[210px] h-[40px] rounded-[50px] bg-[#007F00] hover:bg-green-500 transition-colors duration-300 text-white">Add</button>
       </div>

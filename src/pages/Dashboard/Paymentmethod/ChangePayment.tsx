...
const ChangePayment: React.FC = () => {
  const cardData = [
    {
      cardImg: "./images/visa.svg",
      cardNumber: "*************1234",
      expiryDate: "Expiry 06/2024",
      removeCard: "Set as default",
    },
    {
      cardImg: "./images/applepay.svg",
      cardNumber: "Apple ending in 1234",
      expiryDate: "Expiry 06/2024",
      removeCard: "Set as default",
    },
    {
      cardImg: "./images/masta.svg",
      cardNumber: "Mastercard ending in 1234",
      expiryDate: "Expiry 06/2024",
      removeCard: "Set as default",
    },
  ];
  ...
  return (
    <div className="flex flex-col items-center  mx-auto w-[480px] h-[588px] hover:shadow-lg shadow-md bg-white rounded-[15px] mt-12 gap-6">
      <div className="flex flex-col items-center  w-[432px] h-[468px] mt-6">
        ...
        <div className="flex flex-col items-center justify-center text-[#c7c7c8] mt-2"></div>
              ...
              <div className="flex flex-row w-[380px] h-[68px] justify-between">
                <div className="flex">
                  ...
                  <div className="flex flex-col pl-4">
                    ...
                    <div className="flex flex-row w-[137px] justify-between">
                      <span
                        className={selectedCard === i ? "text-[#007100]" : "text-[#475467]"}
                      >
                        {d.removeCard}
                      </span>
                      <button className="text-[#005A00] font-semibold">Edit</button>

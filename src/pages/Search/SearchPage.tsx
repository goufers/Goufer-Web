...
// import { SearchGoufer } from "../../Redux/SearchGoufersSlice";
...
//       {/* Cards Container */}
//       <div className="grid grid-cols-2 md:grid-cols-3 gap-4 h-auto items-center w-full px-10 py-10">
...
//               <h1 className="text-[#007F00] text-[16px] font-semibold font-Roboto transition duration-300 ease-in-out   hover:scale-105 hover:transition">
//                 {info.Goufername}
//               </h1>
//               <p className="pr-2 text-[11px] mb-2 transition duration-300 ease-in-out   hover:scale-105 hover:transition">
//                 {info.text}
//               </p>
//               <div className="flex flex-row justify-start items-center pb-1 transition duration-300 ease-in-out   hover:scale-105 hover:transition">
//                 <img
...
//                   alt=""
//                 />
//                 <p className="text-[#2e332e] px-2 text-[12px] transition duration-300 ease-in-out   hover:scale-105 hover:transition">
//                   <span className="text-[#007F00] pr-0.5 transition duration-300 ease-in-out   hover:scale-105 hover:transition">
//                     {info.Task}
//                   </span>
//                   Task Complete
//                 </p>
...
//                   alt=""
//                 />
//                 <p className="text-[#2a2b2a] px-2 text-[12px] transition duration-300 ease-in-out   hover:scale-105 hover:transition">
//                   {info.City}
//                 </p>
//               </div>
//               <div className="flex flex-row justify-start items-center pb-1 transition duration-300 ease-in-out   hover:scale-105 hover:transition">
...
//                     alt=""
//                   />
//                   <p className="text-white px-2 text-[12px] transition duration-300 ease-in-out   hover:scale-105 hover:transition">
...
//                   </p>
//                 </div>
//                 <div className="justify-end flex flex-row transition duration-300 ease-in-out   hover:scale-105 hover:transition">
//                   <div className="w-4/5 px-0 py-1 flex flex-row bg-white items-center rounded-full transition duration-300 ease-in-out   hover:scale-105 hover:transition">
//                     <p className="mx-5 text-sm text-[#007F00] font-bold bg-white cursor-pointer transition duration-300 ease-in-out   hover:scale-105 hover:transition">
//                       View Gofer Profile
//                     </p>
//                     <img
...
//             <div
//               key={i}
//               className="flex items-center justify-center w-[40px] h-[40px] border border-[#E6F2E6]"
//             >
//               <button
...
import { RootState, AppDispatch } from '../../Redux/store'; // Import types for state and dispatch
import { fetchInfos } from '../../Redux/SearchGoufersSlice'; // Import your thunk

const SearchPage: React.FC = () => {
  const dispatch = useDispatch<AppDispatch>();
  const { infos, loading, error } = useSelector((state: RootState) => state.infos);
  ...
  useEffect(() => {
    dispatch(fetchInfos()); // Dispatch the fetch action when the component mounts
  }, [dispatch]);
  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 h-auto items-center w-full px-10 py-10">
        {displayInfos.map((info, index) => (
          ...
          >
            ...
            {showExpertPop === index && (
              <div className="absolute bottom-[-22px] w-full h-[22px] bg-[#007F00] text-center text-white text-sm transition duration-300 ease-in-out   hover:scale-105 hover:transition">
                Hire me
              </div>
            )}
          </div>
      ...
      {/* <div className="flex justify-center mb-6">
        <button
          className="mx-1 px-3 py-1 bg-[#007F00] text-white rounded transition duration-300 ease-in-out hover:bg-[#005F00]"
        ...
        {Array.from({ length: totalPages }, (_, index) => (
          <button
            key={index}
            className={mx-1 px-3 py-1 ${currentPage === index + 1 ? 'bg-blue-500 text-white' : 'bg-gray-300 text-black'} rounded transition duration-300 ease-in-out hover:bg-[#005F00]}

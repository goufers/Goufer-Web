  ...
  return (
    <div className="w-full h-auto mb-24">
      ...
      <div className="hidden md:flex  flex-col gap-6 items-center mx-auto rounded-[15px] h-[816px] w-[264px] mb-14 hover:shadow-lg bg-white shadow-md">
        ...
        <div className="w-[930] h-[2000px] md:h-auto md:w-full  flex flex-col gap-6 items-center md:">
        ...
        <div className="w-full md:w-[846px] h-[68px] mx-auto items-center justify-center mb-12 mt-6">

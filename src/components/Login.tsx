      ...
      <div className="bg-white p-8 shadow-md w-[503px] h-[600px] rounded-tl-[25px] rounded-bl-[25px]">
        ...
        <div className="mb-4 relative">
          ...
          <input
            type="email"
            placeholder="Email"
            className="w-[455px] h-[44px] pl-10 pr-4 py-2 rounded-[50px] border border-gray-300 shadow-sm focus:outline-none"
          />
        </div>
        ...
        <div className="mb-4 relative">
          ...
          <input
            ...
            className="w-[455px] h-[44px] pl-10 pr-10 py-2 rounded-[50px] border border-gray-300"
          />
          <button
            type="button"
        ...
        <button className="w-[455px] h-[40px] bg-green-600 text-white rounded-[50px] py-2 px-4 mb-6 hover:bg-green-500">
          Log In
        </button>

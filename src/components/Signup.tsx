    ...
    <div className="mx-auto w-[1006px] h-[800px] justify-center flex flex-row items-center min-h-screen">
      <div className="bg-white p-8 shadow-md w-[503px] h-[700px] rounded-tl-[25px] rounded-bl-[25px] gap-4">
        ...
        <div className="flex gap-2">
          <div className="mb-4 relative">
            <p className="text-[#344054] text-left w-[74px] h-[20px] font-inter font-medium text-[14px] leading-[20px] mb-2">First name</p>
            <input type="text" placeholder="Firstname" className="w-[220px] h-[44px] pl-10 pr-4 py-2 rounded-full border border-gray-300 shadow-sm focus:outline-none" />
          </div>
          <div className="mb-4 relative">
            <p className="text-[#344054] text-left w-[74px] h-[20px] font-inter font-medium text-[14px] leading-[20px] mb-2">Last name</p>
            <input type="text" placeholder="Lastname" className="w-[220px] h-[44px] pl-10 pr-4 py-2 rounded-full border border-gray-300 shadow-sm focus:outline-none" />
          </div>
        </div>

        <div className="mb-4 relative flex flex-col">
          <span>
            <p className="text-[#344054] text-left w-[74px] h-[20px] font-inter font-medium text-[14px] leading-[20px] mb-2">Phone</p>
          </span>
          <PhoneInput
            country={'us'}
            value={phone}
        ...
        <div className="mb-4 relative">
          ...
          <input type="email" placeholder="Email" className="w-[455px] h-[44px] pl-10 pr-4 py-2 rounded-full border border-gray-300 shadow-sm focus:outline-none" />
        </div>
        ...
        <div className="mb-4 relative">
          ...
          <input type={showPassword ? "password" : "text"} placeholder="Password" className="w-[455px] h-[44px] pl-10 pr-10 py-2 rounded-full border border-gray-300" />
        ...
        <button className="w-[455px] h-[40px] bg-green-600 text-white rounded-full py-2 px-4 mb-6 hover:bg-green-500">Sign Up</button>
      ...
      <div className="bg-gray-400 bg-opacity-50 backdrop-filter backdrop-blur-lg p-8 shadow-md w-[503px] h-[700px] rounded-tr-[25px] rounded-br-[25px]">
        <div className="w-[351px] flex flex-col items-center mx-auto mt-14 gap-3">
          ...
          <h1 className="w-[351px] ml-14 text-white">Experienced Assistance at your fingertips</h1>
        </div>
      </div>
    </div>
  );

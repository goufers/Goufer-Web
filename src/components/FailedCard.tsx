...
const FailedCard: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center mx-auto w-[420px] h-[430px] hover:shadow-lg shadow-md bg-white rounded-[15px] mt-12 gap-6">
      <img
      ...
      <div className="flex flex-col items-center justify-center text-[#475467]">
        ...
        <p>We are unable to continue with the process</p>
      </div>

  ...
  return (
    ...
    {/* --------------------------------1 image----------------- */}
      <div className='flex flex-row w-[1440px] h-[181px] mt-20'>
       ...
       <div className='bg-cover bg-center w-[801px] h-[181px] flex flex-col text-white mx-auto items-center justify-center' style={{ backgroundImage: 'url(https://res.cloudinary.com/dspkk9qlz/image/upload/v1717507574/Rectangle_13_gdsbji.svg)' }}>
...
{/* 
     ...
     <div className='w-[1140px] flex flex-row item-center justify-center mx-auto gap-6 mt-10'>

           
     <div className="flex flex-col gap-6 items-center mx-auto rounded-[15px] h-[816px] w-[264px] mb-14 hover:shadow-lg bg-white shadow-md">
...
{/* ---------------------4 cards sections----------------- */}   
  ...
  <div className='w-[930] flex-col items-center'>
    ...
    {/* ----------------cards contents------------- */}
    <div className="w-11/10 grid grid-cols-3 h-[920px] items-center w-[842px]">
 {infos &&

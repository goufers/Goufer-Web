     ...
     <div className='w-[842px] h-[55px] flex items-center justify-around gap[73px]'>
          ...
          <div className="w-[644px] h-[55px] p-4 bg-white rounded-full shadow-md hover:shadow-lg flex flex-row items-center">
            ...
            <div className="flex flex-row gap-3">
              <img src="https://res.cloudinary.com/dspkk9qlz/image/upload/v1717617979/Vector_4_pepcv9.svg" alt="topline1" />
              <img src="https://res.cloudinary.com/dspkk9qlz/image/upload/v1717618131/Vector_uvjbhb.svg" alt="location" />
              <input
                type="text"
            ...
            <div className="flex flex-row gap-3 w-full mx-auto items-center ml-9">
              <img className="h-[44px]" src="https://res.cloudinary.com/dspkk9qlz/image/upload/v1717617979/Vector_4_pepcv9.svg" alt="topline1" />
     ...
     >
       <div className="transition duration-300 ease-in-out hover:scale-105 hover:transition">
         <div className='relative '>
            ...
            <div className=' text-black text-xs h-[26px] w-[116px] rounded-full bg-white flex items-center justify-center'><p>Food and Beverage</p></div>
...
<div className='w-[846px] h-[68px] mx-auto items-center justify-center mb-12 mt-6'>
    ...
    <div className='flex flex-row w-[497px] h-[40px] mx-auto item-center justify-center hover:shadow-lg shadow-md bg-white rounded-[15px]  border-[#E6F2E6]'>
        ...
        <div className='w-[119px] h-[40px]  flex items-center justify-center border-[#E6F2E6]'><img src="https://res.cloudinary.com/dspkk9qlz/image/upload/v1717681157/arrow-left_cq1gnw.svg" alt="previous" />Previous</div>
        <div className='flex flex-row items-center justify-center w-[40px] h-[40px] border border-[#E6F2E6]'>1</div>
        <div className='flex flex-row items-center justify-center w-[40px] h-[40px] border border-[#E6F2E6]'>2</div>
        <div className='flex flex-row items-center justify-center w-[40px] h-[40px] border border-[#E6F2E6]'>3</div>
        <div className='flex flex-row items-center justify-center w-[40px] h-[40px] border border-[#E6F2E6]'>...</div>
        <div className='flex flex-row items-center justify-center w-[40px] h-[40px] border border-[#E6F2E6]'>8</div>
        <div className='flex flex-row items-center justify-center w-[40px] h-[40px] border border-[#E6F2E6]'>9</div>
        <div className='flex flex-row items-center justify-center w-[40px] h-[40px] border border-[#E6F2E6] border-l-none'>10</div>
        <div className='w-[92px] h-[40px]  flex items-center justify-center border-[#E6F2E6] border-l-none'>Next <img src="https://res.cloudinary.com/dspkk9qlz/image/upload/v1717685150/arrow-right_lmffkb.svg" alt="next" /></div>
